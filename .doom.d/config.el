...
(custom-set-variables
 ...
 '(package-selected-packages
	 (quote
		(smart-tabs-mode smart-tab typescript-mode tern-auto-complete speed-type rust-mode reverse-im peep-dired path-iterator org-super-agenda org-plus-contrib org-fancy-priorities lsp-mode key-chord js2-mode flycheck-rust exec-path-from-shell evil-multiedit doom-modeline)))
