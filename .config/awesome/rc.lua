...
function ()
  awful.spawn(string.format("dmenu_run -nb '#282828' -sf '#b8bb26' -sb '#504945' -nf '#a89984' -fn 'Mononoki Nerd Font:bold:pixelsize=14'",
...
awful.key({ modkey, altkey }, "v", function () awful.util.spawn( terminal.." -e nvim " ) end,
