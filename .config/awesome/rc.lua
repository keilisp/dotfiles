...
local mpdmap = {
  ...
  { ".", function() awful.util.spawn("mpc next") end,   "Next" },
  { ",", function() awful.util.spawn("mpc prev") end,   "Prev" },
}

local utilsmap = {
  { "separator", "Packages" },
  { "u", function() awful.util.spawn(terminal .. " -e yay -Syu") end,        "upd packages" },
...
-- { "separator", "Other" },
{ "p", function() awful.util.spawn("pavucontrol") end,        "pavucontrol" },
  }
  ...
  -- Apps map
  awful.key({ modkey }, "p", function() modalbind.grab{keymap=appsmap, name="Apps", layout=0, stay_in_mode=false} end),

  -- Volume map
  awful.key({ modkey }, "v", function() modalbind.grab{keymap=volumemap, name="Volume", layout=0, stay_in_mode=true} end),

  -- Utils map
  awful.key({ modkey }, "y", function() modalbind.grab{keymap=utilsmap, name="Utils", layout=0, stay_in_mode=false} end),
